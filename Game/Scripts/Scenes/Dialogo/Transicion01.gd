...
var dialogo = [
	"Los seres le cuentan a Jorgito una historia muy larga y él procede a anotarlo todo en su diario..."
]
...
func dialogo():
	...
	if numero_dialogo > dialogo.size():
		get_tree().change_scene("res://Game/Scenes/Dialogo/Dialogo05.tscn")
