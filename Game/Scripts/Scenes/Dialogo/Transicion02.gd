...
var dialogo = [
	"De esta forma Jorgito se puso en marcha para cumplir con su misión impuesta por los seres fantásticos..."
]
...
func dialogo():
	...
	if numero_dialogo > dialogo.size():
		get_tree().change_scene("res://Game/Scenes/Dialogo/Transicion03.tscn")
